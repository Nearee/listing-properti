                    ...
                    <tbody>
                        ...
                        foreach ($properti as $item): ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td>
                                    <img src="<?= base_url($item['gambar_url']) ?>" alt="Thumbnail" class="rounded"
                                ...
                                <td>
                                    ...
                                    <form action="<?= base_url('properti/delete/' . $item['id']) ?>" method="post"
                                        class="d-inline">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="btn btn-sm btn-danger mb-1"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus properti ini?')">Hapus</button>
                                    </form>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="editModal<?= $item['id'] ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= base_url('properti/update/' . $item['id']) ?>" method="post"
                                                    ...
                                                    <div class="col-md-6 form-group mb-3">
                                                        ...
                                                        <select name="kategori_tampil" class="form-select" required>
                                                            <option value="tidak_ada"
                                                                <?= ($item['kategori_tampil'] == 'tidak_ada') ? 'selected' : '' ?>>Tidak Ada</option>
                                                            <option value="populer" <?= ($item['kategori_tampil'] == 'populer') ? 'selected' : '' ?>>Populer</option>
                                                            <option value="unggulan"
                                                                <?= ($item['kategori_tampil'] == 'unggulan') ? 'selected' : '' ?>>Unggulan</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_properti"
                                                            value="<?= esc($item['nama_properti']) ?>" required
                                                            maxlength="150">
                                                    </div>
                                                    <div class="col-md-4 form-group mb-3">
                                                        <label>No Rumah</label>
                                                        <input type="text" class="form-control" name="nomor_rumah"
                                                            value="<?= esc($item['nomor_rumah']) ?>" required
                                                            maxlength="20">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="kamar_tidur"
                                                            value="<?= esc($item['kamar_tidur']) ?>" required min="0">
                                                    </div>
                                                    <div class="col-md-6 form-group mb-3">
                                                        <label>Jumlah Kamar Mandi</label>
                                                        <input type="number" class="form-control" name="kamar_mandi"
                                                            value="<?= esc($item['kamar_mandi']) ?>" required min="0">
                                                    </div>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label>Upload Gambar Baru (Maks 2MB, JPG/PNG)</label><br>
                                                    <img src="<?= base_url($item['gambar_url']) ?>" alt="Current Image"
                                                        class="mb-2 rounded" width="120">
                                                    <input type="file" class="form-control" name="gambar_url"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            <label>Kategori Tampil</label>
                            <select name="kategori_tampil" class="form-select" required>
                                <option value="tidak_ada" <?= old('kategori_tampil') == 'tidak_ada' ? 'selected' : '' ?>>
                                    Tidak Ada</option>
                                <option value="populer" <?= old('kategori_tampil') == 'populer' ? 'selected' : '' ?>>
                                    Populer</option>
                                <option value="unggulan" <?= old('kategori_tampil') == 'unggulan' ? 'selected' : '' ?>>
                                    Unggulan</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 form-group mb-3">
                            <label>Nama Properti</label>
                            <input type="text" class="form-control" name="nama_properti"
                                value="<?= old('nama_properti') ?>" placeholder="Misal: Tipe 36" required
                                maxlength="150">
                        </div>
                        <div class="col-md-4 form-group mb-3">
                            <label>No Rumah</label>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" name="harga" value="<?= old('harga') ?>"
                            placeholder="Misal: 350000000" required min="0">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label>Jumlah Kamar Tidur</label>
                            <input type="number" class="form-control" name="kamar_tidur"
                                value="<?= old('kamar_tidur') ?>" required min="0">
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            <label>Jumlah Kamar Mandi</label>
                            <input type="number" class="form-control" name="kamar_mandi"
                                value="<?= old('kamar_mandi') ?>" required min="0">
                        </div>
                    </div>
