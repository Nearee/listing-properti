                                ...
                                <?php foreach ($galeri as $index => $item): ?>
                                    <div class="col-6 col-sm-6 col-lg-3 mt-2 mt-md-0 mb-md-3 mb-2 position-relative">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#galleryModal"
                                            onclick="document.querySelector('#Gallerycarousel').querySelector('[data-bs-slide-to=\'<?= $index ?>\']').click()">
                                            <img class="w-100 rounded" src="<?= base_url($item['gambar_url']) ?>"
                                                alt="Gallery Image <?= $index + 1 ?>" style="height: 200px; object-fit: cover;">
                                        </a>

                                        <form action="<?= base_url('admin/galeri/delete/' . $item['id']) ?>" method="post"
                    ...
                    <div class="carousel-inner">
                        <?php foreach ($galeri as $index => $item): ?>
                            <div class="carousel-item <?= $index == 0 ? 'active' : '' ?>">
                                <img class="d-block w-100" src="<?= base_url($item['gambar_url']) ?>"
                                    alt="Slide <?= $index + 1 ?>" style="max-height: 70vh; object-fit: contain;">
                            </div>
                        <?php endforeach; ?>
                    </div>
