                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($item['status'] == 'pending'): ?>
                                        <form action="<?= base_url('admin/ulasan/approve/' . $item['id']) ?>" method="post"
                                            class="d-inline">
                                            <?= csrf_field() ?>
                                            <button type="submit" class="btn btn-sm btn-success mb-1"
                                                onclick="return confirm('Tampilkan ulasan ini di Landing Page?')">
                                                <i class="bi bi-check-circle"></i> Approve
                                            </button>
                                        </form>
                                    <?php endif; ?>

                                    <form action="<?= base_url('admin/ulasan/delete/' . $item['id']) ?>" method="post"
                                        class="d-inline">
                                        <?= csrf_field() ?>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="detailModalLabel<?= $item['id'] ?>">Detail Ulasan
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <p style="white-space: pre-wrap; font-style: italic;">
                                                    "<?= esc($item['komentar']) ?>"</p>
                                            </div>
                                        </div>
