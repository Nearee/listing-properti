        ...
        <div class="pf-panel mb-5" data-aos="fade-up">
            ...
            <div class="pf-search">
                ...
                <input
                    ...
                    placeholder="Cari nama perumahan atau tipe rumah..."
                    autocomplete="off"
            ...
            <div class="pf-filters">
                ...
                <div class="pf-filter-group">
                    ...
                    <div class="pf-chip-row" data-group="tipe">
                        ...
                        <!-- <button type="button" class="pf-chip" data-value="ruko">Ruko</button> -->
                    </div>
                </div>
                ...
                <div class="pf-filter-group">
                    ...
                    <div class="pf-chip-row" data-group="harga">
                        ...
                        <button type="button" class="pf-chip" data-min="300000000" data-max="500000000">300–500jt</button>
                        <button type="button" class="pf-chip" data-min="500000000" data-max="1000000000">500jt–1M</button>
                        <button type="button" class="pf-chip" data-min="1000000000" data-max="999999999999">&gt; 1M</button>
                    </div>
                </div>
                            ...
                            <a href="<?= $detailUrl ?>"
                               ...
                               data-harga="<?= (int) $hargaRaw ?>">
                                ...
                                <div class="pf-card-body">
                                    ...
                                    <div class="pf-specs">
                                        <span class="pf-spec">
                                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M3 18v-6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M3 18v2M21 18v2M3 12V9a2 2 0 0 1 2-2h6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
                                            <?= $kamarTdr ?> Kasur
                                        </span>
                                        <span class="pf-spec">
                                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 12h16v3a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4v-3Z" stroke="currentColor" stroke-width="1.8"/><path d="M7 12V6a2 2 0 0 1 3-1.7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
                                            <?= $kamarMdi ?> Toilet
                                        </span>
                                    </div>
