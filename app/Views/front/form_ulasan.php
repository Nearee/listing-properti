        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="text-black-50">Pendapat Anda sangat berharga untuk membantu kami memberikan layanan terbaik.</p>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
                    ...
                    <form action="<?= base_url('/simpan-ulasan') ?>" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control px-4 py-3 bg-light border-0" id="nama_klien" name="nama_klien" value="<?= old('nama_klien') ?>" placeholder="Masukkan nama Anda" required>
                        </div>

                        <div class="form-group mb-4">
                            <label for="komentar" class="fw-bold mb-2">Ulasan / Komentar</label>
                            <textarea class="form-control px-4 py-3 bg-light border-0" id="komentar" name="komentar" rows="5" placeholder="Ceritakan pengalaman Anda di sini..." required><?= old('komentar') ?></textarea>
                        </div>
