                ...
                <?php foreach ($layanan as $item): ?>
                    <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="<?= $delay ?>">
                        <div class="box-feature">
                            <span class="<?= esc($item['icon_class']) ?>"></span>
                            <h3 class="mb-3">
                                <?= esc($item['judul']) ?>
                            </h3>
                            <p>
                            ...
                            <?php if (!empty($item['link_url'])): ?>
                                <p><a href="<?= esc($item['link_url']) ?>" class="learn-more">Learn More</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php $delay += 100; ?>
    ...
    <div class="container">
        <div class="row mb-5 align-items-center" data-aos="fade-up">
            ...
            <div class="col-md-5 d-flex justify-content-md-end align-items-center flex-wrap mt-3 mt-md-0">
                <a href="<?= base_url('/beri-ulasan') ?>"
                    class="btn btn-primary rounded-pill px-4 py-2 me-3 shadow-sm d-inline-flex align-items-center"
                    style="transition: transform 0.2s; background: #005555; border: none;">
                ...
                <div id="testimonial-nav" class="d-inline-flex">
                    <span class="prev me-2" data-controls="prev" style="cursor:pointer;"><i
                            class="icon-arrow-left"></i></span>
                    <span class="next" data-controls="next" style="cursor:pointer;"><i
                    ...
                    <?php foreach ($ulasan as $u): ?>
                        <div class="item">
                            <div class="testimonial">
                                <img src="<?= !empty($u['avatar_url']) ? base_url($u['avatar_url']) : base_url('assets/images/pp.png') ?>"
                                    alt="Foto <?= esc($u['nama_klien']) ?>" class="img-fluid rounded-circle mb-4"
    ...
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-5">
                ...
                <p class="text-black-50">
                    Wujudkan hunian ideal untuk Anda dan keluarga. Kami menyediakan platform pencarian properti
                    terlengkap dengan proses yang cepat, transparan, dan terpercaya.
                </p>
            </div>
        </div>
